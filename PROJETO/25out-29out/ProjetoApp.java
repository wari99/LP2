...
class ProjetoFrame extends JFrame {
	...
	buts.add(new Button(0, new Rect(0,0,0,0,Color.BLUE, Color.GREEN)));	
	buts.add(new Button(1, new Ellipse(0,0,0,0,Color.BLUE, Color.GREEN)));	
	buts.add(new Button(2, new Arco(0,0,0,0,Color.BLUE, Color.GREEN,0,0)));	
	buts.add(new Button(3, new Triangulo(0,0,0,0,Color.BLUE, Color.GREEN)));
	...
	this.addMouseListener(
			...
			public void mousePressed (MouseEvent evt) { 
				...
				for (Button but: buts) {  // loop botoes
					if (but.clicked(x,y)) {
						focus_but = but;
						repaint();
						break;
